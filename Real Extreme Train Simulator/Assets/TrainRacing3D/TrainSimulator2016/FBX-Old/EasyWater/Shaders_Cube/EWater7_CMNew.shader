...
_Opacity("_Opacity", Range(-1.1,1.0) ) = 0
_Reflection("_Reflection", Cube) = "black" {}
_ReflectPower("_ReflectPower", Range(0,2) ) = 0
...
//		ColorMask RGBA
		...
		inline half4 LightingBlinnPhongEditor (EditorSurfaceOutput s, half3 lightDir, half3 viewDir, half atten)
		{
			...
			half4 res;
			res.rgba = _LightColor0.rgba * diff;
			res.w = spec * Luminance (_LightColor0.rgba);
			res *= atten * 2.0;
