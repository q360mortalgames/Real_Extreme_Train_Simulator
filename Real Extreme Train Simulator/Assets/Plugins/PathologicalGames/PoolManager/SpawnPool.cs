...
namespace PathologicalGames
{
	...
	public sealed class SpawnPool : MonoBehaviour, IList<Transform>
    {
        ...
        /// </returns>
        public Transform Spawn(Transform prefab, Vector3 pos, Quaternion rot, Transform parent, int slotNum = -1)
        {
            Transform inst;
            ...
            for (int i = 0; i < this._prefabPools.Count; i++)
            {
                ...
                if (this._prefabPools[i].prefabGO == prefab.gameObject)
                {
                    ...
                    inst = this._prefabPools[i].SpawnInstance(pos, rot,slotNum);
            ...
            inst = newPrefabPool.SpawnInstance(pos, rot,slotNum);
        ...
        /// </summary>
        public Transform Spawn(Transform prefab, Vector3 pos, Quaternion rot, int slotNum = -1)
        {
            Transform inst = this.Spawn(prefab, pos, rot, null,slotNum);
        ...
        /// <returns></returns>
        //private IEnumerator ListenForEmitDespawn( emitter)
        //{
    ...
    public class PrefabPool
    {
        ...
        /// reached.
        /// </returns>    
        internal Transform SpawnInstance(Vector3 pos, Quaternion rot,int slotNum = -1)
        {
            ...
            if (this._despawned.Count == 0)
            {
                ...
                inst = this.SpawnNew(pos, rot,slotNum);
            }
            else
            {
        ...
        public Transform SpawnNew(Vector3 pos, Quaternion rot,int slotNum = -1)
        {
			...
			if (slotNum >= 0) {
				Debug.Log("New bomb animation instantiated.."+slotNum);
			}
